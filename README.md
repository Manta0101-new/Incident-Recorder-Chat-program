...
## About
this program is a stand alone version of the chat program. It was meant to be used in Security Incident Response teams as a alternate channel. the default port for the server is 570001. 
